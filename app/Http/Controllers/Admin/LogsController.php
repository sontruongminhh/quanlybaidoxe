...
class LogsController extends Controller
{
    ...
    public function all_log()
    {
        $all_log =  log::select(
            ...
            ->join('parking_lots', 'parking_lots.parkingid', 'logs.parkingid')
            ->join('parking_slots','parking_slots.parking_slotid','logs.parking_slotid')
            ->join('users', 'users.userid','logs.customerid')
