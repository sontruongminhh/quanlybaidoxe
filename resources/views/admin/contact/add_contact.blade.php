                ...
                <div class="position-center">
                    <form role="form" action="{{ route('update_contact', ['contact_id' => $edit_contact->contactid]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="contact_userid" class="form-control" id="contact_userid" value="{{ $edit_contact->userid }}">
                        </div>
                        <div class="form-group">
                            <label for="contact_subject">Tiêu đề</label>
                            <input type="text" name="contact_subject" class="form-control" id="contact_subject" value="{{ $edit_contact->subject }}">
                        </div>
                        <div class="form-group">
                            <label for="contact_message">Nội dung</label>
                            <input type="text" name="contact_message" class="form-control" id="contact_message" value="{{ $edit_contact->message }}">
                        </div>
                        <div class="form-group">
                            <label for="contact_contact_time">Thời gian gửi</label>
                            <input type="text" name="contact_contact_time" class="form-control" id="contact_contact_time" value="{{ $edit_contact->contact_time }}">
                        </div>
                        <div class="form-group">
                            <label for="contact_status">Trạng thái</label>
                            <input type="text" name="contact_status" class="form-control" id="contact_status" value="{{ $edit_contact->status }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="contact_response_time" class="form-control" id="contact_response_time" value="{{ $edit_contact->response_time }}">
                        </div>
