            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="user_Admin" class="form-control" id="exampleInputEmail1" placeholder="">
                    </div>
                   
                    <button type="submit" name="add_blog" class="btn btn-info">Thêm người dùng</button>
